                    ...
                    <div class="form-input-content">
                        <div class="card login-form mt-5">
                            <div class="card-body shadow">   
                                    ...
                                    <h2 class="text-center pb-4">Hệ thống điểm danh nhân viên</h2>
                                    <h6 class="text-center pb-4">Hãy chọn mục mà bạn muốn đăng nhập!</h6>
                
                                <div class="container mt-4">

                                  <div class="btn-toolbar justify-content-between">
                                        <div class="btn-group">
                                            <a href="employee/dashboard.php" class="btn btn-primary btn-lg">Tài khoản nhân viên </a>
                                        </div>

                                        <div class="btn-group">
                                        
                                            <a href="admin/dashboard.php" class="btn btn-primary btn-lg">Tài khoản Admin</a>
                                        </div>
